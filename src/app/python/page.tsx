...
const pythonTopics = [
    ...
    },
    {
        ...
        bgColor: '#eef2ff',
        borderColor: '#a5b4fc',
        desc: 'User defined functions, arguments (positional, default, keyword) & recursion',
        chapter: 7,
        duration: '2.5 Hours',
        lessons: 12,
        locked: false,
    ...
    },
    {
        ...
        href: '/python/file-processing',
        icon: <Database size={24} />,
        color: '#f43f5e',
        bgColor: '#fff1f2',
        borderColor: '#fb7185',
        desc: 'Text vs Binary files, reading, writing, seeking and pickling data',
        chapter: 8,
        duration: '3 Hours',
        lessons: 15,
        locked: false,
