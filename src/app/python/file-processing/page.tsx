...
shop = open('product') # default mode is 'r'`} />
                        ...
                        <MC name="(ii) close()" desc="फ़ाइल को बंद करने के लिए" color="#8b5cf6">
                            <p className="text-sm text-slate-600 mb-3">काम पूरा होने के बाद फाइल को close करना आवश्यक है।</p>
...
student.write(nm)`} />
                        ...
                        <ProgCard title="Program 1 — Student Data">
...
student.close()`} />
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <div className="p-4 rounded-xl" style={{ border: '1px solid #e2e8f0', background: '#f8fafc' }}>
                                ...
                                <p className="text-xs text-slate-600 mb-2">यह function फाइल से केवल उतनी bytes read करता है जितनी argument में दी गई है।</p>
                                <code className="text-xs bg-slate-200 px-1 py-0.5 rounded">student.read(30)</code>
                            </div>
                            <div className="p-4 rounded-xl" style={{ border: '1px solid #e2e8f0', background: '#f8fafc' }}>
                                <p className="text-sm font-bold text-slate-800 mb-1">(B) readlines()</p>
                                <p className="text-xs text-slate-600 mb-2">फाइल से total information read करने के लिए इस function का प्रयोग होता है और यह list return करता है।</p>
                                <code className="text-xs bg-slate-200 px-1 py-0.5 rounded">n = student.readlines()</code>
                            </div>
                            <div className="p-4 rounded-xl" style={{ border: '1px solid #e2e8f0', background: '#f8fafc' }}>
...
print("position after 3 bytes:", f.tell())`} />
                            ...
                            <MC name="2. seek()" desc="change pointer" color="#0ea5e9">
                                <p className="text-xs text-slate-600 mb-2">FP की position बदलने के लिए।</p>
                                <CB code={`f.seek(10)
                    ...
                    <Sec id="binary-file" title="2. Binary File Processing →" icon={<Database size={18} className="text-pink-600" />}>
                        ...
                        <div className="p-4 rounded-xl mb-4" style={{ background: '#fdf4ff', border: '1px solid #f5d0fe' }}>
                            ...
                            <ul className="list-disc list-inside text-sm text-fuchsia-900/80 mb-3 space-y-1">
                                <li><strong>Serialize:</strong> data को bytes में बदलना।</li>
                                <li><strong>De-Serialize:</strong> bytes को simple format में बदलना।</li>
                            </ul>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                            <MC name="(2) open() - Binary" desc="फ़ाइल को बाइनरी मोड में ओपन करने के लिए" color="#ec4899">
                                <p className="text-xs text-slate-600 mb-2">Modes: <code>wb</code>, <code>rb</code>, <code>ab</code>, <code>wb+</code>, <code>rb+</code>, <code>ab+</code></p>
                                <div className="overflow-x-auto mb-3">
                                    <table className="min-w-full text-left text-xs text-slate-700 border-collapse border border-slate-200">
                                        <thead>
                                            <tr className="bg-slate-100">
                                                <th className="p-1 border border-slate-200">Mode</th>
                                                <th className="p-1 border border-slate-200">Purpose</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr><td className="p-1 border border-slate-200 font-mono font-bold">wb</td><td className="p-1 border border-slate-200">write</td></tr>
                                            <tr><td className="p-1 border border-slate-200 font-mono font-bold">rb</td><td className="p-1 border border-slate-200">read</td></tr>
                                            <tr><td className="p-1 border border-slate-200 font-mono font-bold">ab</td><td className="p-1 border border-slate-200">append</td></tr>
                                            <tr><td className="p-1 border border-slate-200 font-mono font-bold">wb+</td><td className="p-1 border border-slate-200">write & read</td></tr>
                                            <tr><td className="p-1 border border-slate-200 font-mono font-bold">rb+</td><td className="p-1 border border-slate-200">read & write</td></tr>
                                            <tr><td className="p-1 border border-slate-200 font-mono font-bold">ab+</td><td className="p-1 border border-slate-200">append & read</td></tr>
                                        </tbody>
                                    </table>
                                </div>
